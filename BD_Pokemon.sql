...
create table Fazenda( /*criação de tabela*/
    ...
    insert into fazenda values(1, 1, 1); /*insere valorores nos atributos*/
    insert into fazenda values(2, 2, 2);
    insert into fazenda values(3, 3, 3);
    insert into fazenda values(4, 4, 4);
    insert into fazenda values(5, 5, 5);
    insert into fazenda values(6, 6, 6);
...
create table Treinador( /*criação de tabela*/
	...
	Gostos varchar(45)
		...
		insert into Treinador values(6, 'Rosani', '1988-11-30', 'Brava', 'Mnadar'); /*insere valorores nos atributos*/
